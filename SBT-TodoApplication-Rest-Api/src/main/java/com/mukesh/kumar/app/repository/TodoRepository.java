...
public class TodoRepository {
	...
	public TodoRepository() {
		...
		todoList.add(new Todos(101L, "Create UI Page", "create User Registration Page", false, new Date(), null));
		todoList.add(new Todos(102L, "Create Database", "create database in Oracle Db", true, new Date(), null));
		todoList.add(
				new Todos(103L, "Access Payment Api", "Use Payment Api to accept payment ", false, new Date(), null));
		todoList.add(new Todos(104L, "Create Login Api", "create Api Login Page", true, new Date(), null));
	}
